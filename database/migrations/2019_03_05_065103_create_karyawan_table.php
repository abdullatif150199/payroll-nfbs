...
class CreateKaryawanTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('karyawan', function (Blueprint $table) {
            ...
            $table->foreign('tarif_lembur_id')->references('id')->on('tarif_lembur')->onDelete('cascade');
            ...
            $table->foreign('jam_perpekan_id')->references('id')->on('jam_perpekan')->onDelete('cascade');
