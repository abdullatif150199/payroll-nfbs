        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">
                    <form class="form-inline" action="{{ route('dash.getKinerja') }}" method="post">
                        ...
                        <div class="row gutters-xs">
                            <div class="col">
                                <select name="month" class="form-control custom-select" onchange="$('#daftarKinerja').DataTable().draw()">
                            ...
                            <div class="col">
                                <select name="year" class="form-control custom-select" onchange="$('#daftarKinerja').DataTable().draw()">
                ...
                <div class="card-options">
                    <button type="button" id="newKinerja" class="btn btn-primary"><i class="fe fe-plus"></i> Tambah</button>
                </div>
            </div>
