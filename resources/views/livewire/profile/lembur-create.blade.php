            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="number" wire:model.lazy="jumlah_jam" class="form-control" required>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <select wire:model.lazy="day" class="form-control" required>
                            <option value=""></option>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <select wire:model.lazy="month" class="form-control" required>
                            <option value=""></option>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <select wire:model.lazy="year" class="form-control" required>
                            <option value=""></option>
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" wire:model.lazy="keterangan" class="form-control" placeholder="Opsional">
                    </div>
                </div>
            </div>
        </div>
