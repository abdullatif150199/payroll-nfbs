...
@section('title', 'Daftar Gaji | ' . config('tabler.suffix'))
@push('styles')
                ...
                <h3 class="card-title">
                    <form class="form-inline" action="{{ route('getGaji') }}" method="post">
                        <div class="form-group">
                            <label for="month">Daftar Gaji Bulan </label>
                            <select name="month" class="form-control custom-select mx-sm-3" onchange="$('#daftarGaji').DataTable().draw()">
