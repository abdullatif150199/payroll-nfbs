...
<div class="modal fade" id="expiryDate">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title">Edit Expiry Date {{ $data->nama_lengkap }}</h4>
                <button type="button" class="close" data-dismiss="modal"></button>
            </div>
            ...
            <form method="post">
                ...
                <input type="hidden" name="karyawan_id" value="{{ $data->id }}">
                <input type="hidden" name="potongan_id">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="form-label">Expiry Date</label>
                        <div class="row gutters-xs">
                            <div class="col">
                                <select id="end_month" name="end_at[month]" class="form-control custom-select">
                                    <option value="">Bulan</option>
                                    <option value="01">Januari</option>
                                    <option value="02">Februari</option>
                                    <option value="03">Maret</option>
                            ...
                            <div class="col">
                                <select id="end_year" name="end_at[year]" class="form-control custom-select">
                                    <option value="">Tahun</option>
                                    @for ($i=date('Y'); $i <= date('Y') + 50; $i++) <option value="{{$i}}">
                                        {{$i}}</option>
                                        @endfor
