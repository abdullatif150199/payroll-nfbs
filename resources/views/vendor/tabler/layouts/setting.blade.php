                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="card">
                                    ...
                                    <table class="table card-table">
                                        <tbody>
                                            <tr>
                                                <td width="1"><i class="{{ Route::is('dash.setting') ? 'fa fa-circle' : 'fa fa-circle-o' }} text-primary"></i></td>
                                                <td><a href="{{ route('dash.setting') }}">Users</a></td>
                                            </tr>
                                            <tr>
                                                <td width="1"><i class="{{ Route::is('dash.golongan') ? 'fa fa-circle' : 'fa fa-circle-o' }} text-primary"></i></td>
