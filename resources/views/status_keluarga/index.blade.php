...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-options">
            <button type="button" id="newKeluarga" class="btn btn-primary"><i class="fe fe-plus"></i> Tambah</button>
        </div>
    </div>
    <div class="table-responsive">
        <table class="table card-table table-vcenter text-nowra" id="daftarKeluarga">
            <thead>
                <tr>
                    <th>Title</th>
