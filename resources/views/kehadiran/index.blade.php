        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-options">
                    <a class="btn btn-primary mr-2" href="{{ route('dash.kehadiran.insertview') }}"><i class="fe fe-check-square"></i> Input</a>
                    <a class="btn btn-primary mr-2" href="?list=apel"><i class="fe fe-check-square"></i> Hadir Apel</a>
                    <a class="btn btn-primary" href="?list=persentase"><i class="fe fe-bar-chart-2"></i> % Kehadiran</a>
                </div>
            </div>
